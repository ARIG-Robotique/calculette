    ...
    <form>
        <InputNumber label="Carrés de fouille basculés (5 pts)"
            ...
            <template v-slot:help>
                5 points pour chaque carré de fouille basculé à la couleur de l’équipe. 5 points supplémentaires si au
                moins un carré de fouille est basculé.
            </template>
        </InputNumber>
        ...
        <InputCheckbox label="Forfait (1 pt)"
